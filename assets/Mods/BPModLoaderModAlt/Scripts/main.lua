...
-- Contains mod names from Mods/BPModLoaderModAlt/load_order.txt and is used to determine the load order of BP mods.
local ModOrderList = {}
...
local function LoadModOrder()
    local file = 'Mods/BPModLoaderModAlt/load_order.txt'
    ...
    if entriesAdded <= 0 then
        Log(string.format("Mods/BPModLoaderModAlt/load_order.txt not present or no matching mods, loading all BP mods in random order."))
    end
end
